    ...
    return (
      ...
      >
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm text-blue-800 dark:text-blue-200">Testing Home Assistant connection...</span>
        </div>
      </div>
    )
  }
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-medium text-green-800 dark:text-green-200">Connected to {haInfo.name}</span>
              {haInfo.version && (
                <span className="text-xs text-green-600 dark:text-green-400">Version {haInfo.version}</span>
              )}
            </div>
          </div>
